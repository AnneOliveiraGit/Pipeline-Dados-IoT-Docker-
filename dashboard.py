...
fig1 = px.bar(df_avg_temp, x='device_id', y='avg_temp', title='Média por Dispositivo')
...
fig3 = px.line(df_temp_max_min, x='data', y=['temp_max', 'temp_min'], title='Máx / Mín por Dia')
